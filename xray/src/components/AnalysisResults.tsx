  ...
  return (
    ...
    >
      <div className="grid grid-cols-1 md:grid-cols-4 gap-6 max-w-6xl mx-auto">
        {/* Summary Card */}
        <Card className="bg-muted animate-fade-in" style={{animationDelay: '0ms'}}>
        ...
        {/* Platforms Card */}
        <Card className="bg-muted animate-fade-in" style={{animationDelay: '200ms'}}>
          <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-2">
        ...
        {/* Key Insights Card */}
        <Card className="bg-muted animate-fade-in" style={{animationDelay: '400ms'}}>
          <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-2">
        ...
        {/* Debates Card */}
        <Card className="bg-muted animate-fade-in" style={{animationDelay: '600ms'}}>
          <CardHeader className="flex flex-row items-start justify-between space-y-0 pb-2">
